...
import { useReferenceOneFieldController, useRecordContext, ResourceContextProvider, useCreatePath, } from 'ra-core';
...
export var ReferenceOneField = function (props) {
    ...
    return !record || (!isLoading && referenceRecord == null) ? (emptyText ? (React.createElement(Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (React.createElement(ResourceContextProvider, { value: reference },
