...
import { useChoicesContext, useInput, FieldTitle, useTranslate, useChoices, } from 'ra-core';
...
export var SelectInput = function (props) {
    ...
    var _c = useChoicesContext({
        ...
        source: sourceProp,
    }), allChoices = _c.allChoices, isLoading = _c.isLoading, source = _c.source, resource = _c.resource;
    var _d = useChoices({
    ...
    var _e = useInput(__assign({ defaultValue: defaultValue, format: format, parse: parse, onBlur: onBlur, onChange: onChange, resource: resource, source: source, validate: validate }, rest)), field = _e.field, fieldState = _e.fieldState, id = _e.id, isRequired = _e.isRequired, isSubmitted = _e.formState.isSubmitted;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledResettableTextField, __assign({ id: id }, field, { className: clsx('ra-input', "ra-input-".concat(source), className), onChange: handleChangeWithCreateSupport, select: true, label: label !== '' &&
                label !== false && (React.createElement(FieldTitle, { label: label, source: source, resource: resourceProp, isRequired: isRequired })), clearAlwaysVisible: true, error: (isTouched || isSubmitted) && invalid, helperText: React.createElement(InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }), margin: margin }, sanitizeRestProps(rest)),
            React.createElement(MenuItem, { value: emptyValue, key: "null", "aria-label": translate('ra.action.clear_input_value'), title: translate('ra.action.clear_input_value') }, renderEmptyItemOption()),
