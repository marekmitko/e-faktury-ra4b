...
var FilterButton = function (props) {
    ...
    var _a = (0, ra_core_1.useListContext)(props), _b = _a.displayedFilters, displayedFilters = _b === void 0 ? {} : _b, filterValues = _a.filterValues, perPage = _a.perPage, showFilter = _a.showFilter, sort = _a.sort;
    ...
    return (React.createElement(Root, __assign({ className: className }, sanitizeRestProps(rest)),
        ...
        React.createElement(material_1.Menu, { open: open, anchorEl: anchorEl.current, onClose: handleRequestClose },
            ...
            hasFilterValues && !hasSavedCurrentQuery ? (React.createElement(material_1.MenuItem, { onClick: showAddSavedQueryDialog }, translate('ra.saved_queries.new_label', {
