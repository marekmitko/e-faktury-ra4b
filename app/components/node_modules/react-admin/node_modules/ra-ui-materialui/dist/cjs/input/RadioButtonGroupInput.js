...
var RadioButtonGroupInput = function (props) {
    ...
    var _b = (0, ra_core_1.useChoicesContext)({
        ...
        source: sourceProp,
    }), allChoices = _b.allChoices, isLoading = _b.isLoading, resource = _b.resource, source = _b.source;
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), margin: margin, error: (isTouched || isSubmitted) && invalid }, sanitizeRestProps(rest)),
