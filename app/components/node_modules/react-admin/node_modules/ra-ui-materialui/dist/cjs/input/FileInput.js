...
var FileInput = function (props) {
    ...
    var isTouched = fieldState.isTouched, error = fieldState.error;
    ...
    return (react_1.default.createElement(StyledLabeled, __assign({ htmlFor: id, label: label, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), source: source, resource: resource, isRequired: isRequired }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        react_1.default.createElement(react_1.default.Fragment, null,
            ...
            children && (react_1.default.createElement("div", { className: "previews" }, files.map(function (file, index) { return (react_1.default.createElement(FileInputPreview_1.FileInputPreview, { key: index, file: file, onRemove: onRemove(file), className: exports.FileInputClasses.removeButton }, (0, react_1.cloneElement)(childrenElement, {
                record: file,
                className: exports.FileInputClasses.preview,
            }))); }))))));
};
...
var StyledLabeled = (0, styles_1.styled)(Labeled_1.Labeled, {
    ...
    return (_b = {
        ...
        _b["& .".concat(exports.FileInputClasses.preview)] = {},
