...
var ShowView = function (props) {
    ...
    var _d = (0, ra_core_1.useShowContext)(props), defaultTitle = _d.defaultTitle, record = _d.record;
    ...
    return (React.createElement(Root, __assign({ className: (0, clsx_1.default)('show-page', className) }, sanitizeRestProps(rest)),
        React.createElement(layout_1.Title, { title: title, defaultTitle: defaultTitle }),
