...
var LoadingInput = function (_a) {
    var label = _a.label, helperText = _a.helperText, margin = _a.margin, size = _a.size, sx = _a.sx, _b = _a.timeout, timeout = _b === void 0 ? 1000 : _b, variant = _a.variant;
    var oneSecondHasPassed = (0, ra_core_1.useTimeout)(timeout);
    return (React.createElement(StyledResettableTextField, { sx: sx, label: label, helperText: helperText, variant: variant, margin: margin, size: size, disabled: true, onChange: function () { }, InputProps: {
