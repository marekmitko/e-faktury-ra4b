...
var ArrayInput = function (props) {
    var className = props.className, defaultValue = props.defaultValue, label = props.label, isFetching = props.isFetching, isLoading = props.isLoading, children = props.children, helperText = props.helperText, record = props.record, resourceFromProps = props.resource, source = props.source, validate = props.validate, variant = props.variant, disabled = props.disabled, _a = props.margin, margin = _a === void 0 ? 'dense' : _a, rest = __rest(props, ["className", "defaultValue", "label", "isFetching", "isLoading", "children", "helperText", "record", "resource", "source", "validate", "variant", "disabled", "margin"]);
    ...
    var _b = (0, react_hook_form_1.useFormContext)(), getFieldState = _b.getFieldState, clearErrors = _b.clearErrors, formState = _b.formState, getValues = _b.getValues, register = _b.register, setError = _b.setError, unregister = _b.unregister;
    ...
    var value = (0, react_hook_form_1.useWatch)({ name: source });
    var _c = getFieldState(source, formState), isDirty = _c.isDirty, invalid = _c.invalid, error = _c.error;
    // As react-hook-form does not handle validation on the array itself,
    // we need to do it manually
    var errorRef = (0, react_1.useRef)(null);
    (0, react_1.useEffect)(function () {
        var applyValidation = function () { return __awaiter(void 0, void 0, void 0, function () {
            var newError;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sanitizedValidate(value, getValues(), props)];
                    case 1:
                        newError = _a.sent();
                        if (newError && !(0, isEqual_1.default)(errorRef.current, newError)) {
    ...
    return (React.createElement(material_1.FormControl, __assign({ fullWidth: true, margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), error: (isDirty || isSubmitted) && invalid }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        React.createElement(material_1.InputLabel, { htmlFor: source, shrink: true, error: (isDirty || isSubmitted) && invalid },
        ...
        !!((isDirty || isSubmitted) && invalid) || helperText ? (React.createElement(material_1.FormHelperText, { error: (isDirty || isSubmitted) && invalid },
            React.createElement(InputHelperText_1.InputHelperText, { touched: isDirty || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }))) : null));
};
