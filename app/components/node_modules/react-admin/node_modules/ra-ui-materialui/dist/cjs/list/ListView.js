...
var ListView = function (props) {
    ...
    var _e = (0, ra_core_1.useListContext)(props), defaultTitle = _e.defaultTitle, data = _e.data, error = _e.error, total = _e.total, isLoading = _e.isLoading, filterValues = _e.filterValues;
    ...
    return (React.createElement(Root, __assign({ className: (0, clsx_1.default)('list-page', className) }, rest),
        React.createElement(Title_1.Title, { title: title, defaultTitle: defaultTitle }),
