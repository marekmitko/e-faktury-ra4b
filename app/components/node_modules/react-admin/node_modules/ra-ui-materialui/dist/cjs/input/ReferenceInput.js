...
var ReferenceError_1 = require("./ReferenceError");
/**
...
var ReferenceInput = function (props) {
    ...
    if (controllerProps.error) {
        return react_1.default.createElement(ReferenceError_1.ReferenceError, { label: label, error: controllerProps.error });
    }
