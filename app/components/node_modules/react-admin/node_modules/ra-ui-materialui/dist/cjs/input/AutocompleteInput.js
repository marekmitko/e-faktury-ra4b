...
var AutocompleteInput = function (props) {
    ...
    // a second has passed.
    var currentChoices = (0, react_1.useRef)(allChoices);
    (0, react_1.useEffect)(function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledAutocomplete, __assign({ blurOnSelect: true, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), openOnFocus: true, openText: translate(openText, { _: openText }), id: id, isOptionEqualToValue: isOptionEqualToValue, filterSelectedOptions: true, renderInput: function (params) { return (React.createElement(material_1.TextField, __assign({ name: field.name, label: React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resourceProp, isRequired: typeof isRequiredOverride !== 'undefined'
                        ? isRequiredOverride
                        : isRequired }), error: (isTouched || isSubmitted) && invalid, helperText: React.createElement(InputHelperText_1.InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }), margin: margin, variant: variant, className: exports.AutocompleteInputClasses.textField }, TextFieldProps, params, { size: size }))); }, multiple: multiple, renderTags: function (value, getTagProps) {
                ...
                : noOptionsText, selectOnFocus: true, clearOnBlur: true }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest), { freeSolo: !!create || !!onCreate, handleHomeEndKeys: !!create || !!onCreate, filterOptions: filterOptions, options: shouldRenderSuggestions == undefined || // eslint-disable-line eqeqeq
