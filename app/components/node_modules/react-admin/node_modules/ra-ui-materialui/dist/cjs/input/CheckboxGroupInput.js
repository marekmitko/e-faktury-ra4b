...
var CheckboxGroupInput = function (props) {
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", margin: margin, error: (isTouched || isSubmitted) && invalid, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) }, sanitizeRestProps(rest)),
