...
var Title = function (props) {
    var className = props.className, defaultTitle = props.defaultTitle, title = props.title, rest = __rest(props, ["className", "defaultTitle", "title"]);
    ...
    var titleElement = !title ? (React.createElement("span", __assign({ className: className }, rest), defaultTitle)) : typeof title === 'string' ? (React.createElement("span", __assign({ className: className }, rest), translate(title, { _: title }))) : (title);
