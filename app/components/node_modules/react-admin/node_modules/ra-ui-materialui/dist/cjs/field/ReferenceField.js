...
var ReferenceField = function (props) {
    ...
    return id == null ? (emptyText ? (React.createElement(material_1.Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (React.createElement(exports.NonEmptyReferenceField, __assign({}, rest, { emptyText: emptyText, record: record, id: id })));
};
    ...
    if (resourceLinkPath) {
        return (React.createElement(Root, { className: className, sx: sx },
            React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord },
                React.createElement(Link_1.Link, { to: resourceLinkPath, className: exports.ReferenceFieldClasses.link, onClick: stopPropagation }, children))));
    }
    return (React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord }, children));
};
