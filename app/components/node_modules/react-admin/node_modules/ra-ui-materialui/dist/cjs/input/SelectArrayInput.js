...
var SelectArrayInput = function (props) {
    ...
    var _a = (0, ra_core_1.useChoicesContext)({
        ...
        source: sourceProp,
    }), allChoices = _a.allChoices, isLoading = _a.isLoading, source = _a.source, resource = _a.resource;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledFormControl, __assign({ margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), error: (isTouched || isSubmitted) && invalid, variant: variant }, sanitizeRestProps(rest)),
            React.createElement(material_1.InputLabel, { ref: inputLabel, id: "".concat(label, "-outlined-label"), error: (isTouched || isSubmitted) && invalid },
                React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired })),
            React.createElement(material_1.Select, __assign({ autoWidth: true, labelId: "".concat(label, "-outlined-label"), multiple: true, error: (isTouched || isSubmitted) && invalid, renderValue: function (selected) { return (React.createElement("div", { className: exports.SelectArrayInputClasses.chips }, selected
                    .map(function (item) {
            ...
            React.createElement(material_1.FormHelperText, { error: isTouched && !!error },
