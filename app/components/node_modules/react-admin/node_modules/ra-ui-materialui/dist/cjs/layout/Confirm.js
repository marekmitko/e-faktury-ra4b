...
var Confirm = function (props) {
    var _a;
    var className = props.className, _b = props.isOpen, isOpen = _b === void 0 ? false : _b, loading = props.loading, title = props.title, content = props.content, _c = props.cancel, cancel = _c === void 0 ? 'ra.action.cancel' : _c, _d = props.confirm, confirm = _d === void 0 ? 'ra.action.confirm' : _d, _e = props.confirmColor, confirmColor = _e === void 0 ? 'primary' : _e, _f = props.ConfirmIcon, ConfirmIcon = _f === void 0 ? CheckCircle_1.default : _f, _g = props.CancelIcon, CancelIcon = _g === void 0 ? ErrorOutline_1.default : _g, onClose = props.onClose, onConfirm = props.onConfirm, _h = props.translateOptions, translateOptions = _h === void 0 ? {} : _h, sx = props.sx;
    ...
    return (React.createElement(StyledDialog, { className: className, open: isOpen, onClose: onClose, onClick: handleClick, "aria-labelledby": "alert-dialog-title", sx: sx },
        ...
        React.createElement(DialogActions_1.default, null,
            React.createElement(Button_1.default, { disabled: loading, onClick: onClose },
                React.createElement(CancelIcon, { className: exports.ConfirmClasses.iconPaddingStyle }),
            ...
            React.createElement(Button_1.default, { disabled: loading, onClick: handleConfirm, className: (0, clsx_1.default)('ra-confirm', (_a = {},
                    ...
                    _a)), autoFocus: true },
                React.createElement(ConfirmIcon, { className: exports.ConfirmClasses.iconPaddingStyle }),
...
var StyledDialog = (0, styles_1.styled)(Dialog_1.default, {
    ...
    return (_b = {},
        ...
        _b["& .".concat(exports.ConfirmClasses.iconPaddingStyle)] = {
            paddingRight: '0.5em',
        },
        _b);
});
