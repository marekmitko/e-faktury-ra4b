...
var ReferenceOneField = function (props) {
    ...
    return !record || (!isLoading && referenceRecord == null) ? (emptyText ? (react_1.default.createElement(material_1.Typography, { component: "span", variant: "body2" }, emptyText)) : null) : (react_1.default.createElement(ra_core_1.ResourceContextProvider, { value: reference },
