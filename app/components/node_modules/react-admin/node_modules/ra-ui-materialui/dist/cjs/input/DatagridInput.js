...
var DatagridInput = function (props) {
    ...
    var _c = (0, ra_core_1.useChoicesContext)({
        ...
        source: sourceProp,
    }), allChoices = _c.allChoices, availableChoices = _c.availableChoices, selectedChoices = _c.selectedChoices, source = _c.source, choicesContext = __rest(_c, ["allChoices", "availableChoices", "selectedChoices", "source"]);
    ...
    return (React.createElement("div", { className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) },
        React.createElement(ra_core_1.ListContextProvider, { value: listContext },
            ...
            React.createElement(InputHelperText_1.InputHelperText, { touched: fieldState.isTouched || formState.isSubmitted, error: (_a = fieldState.error) === null || _a === void 0 ? void 0 : _a.message }))));
};
