...
var flattenErrors = function (obj, path) {
    ...
    return !(0, isObject_1.default)(obj)
        ? (_a = {}, _a[path.join('.')] = obj, _a) : (0, reduce_1.default)(obj, function (cum, next, key) {
        var _a;
        if (obj[key].message !=
            null &&
            obj[key].args != null) {
            return (0, merge_1.default)(cum, (_a = {}, _a[key] = obj[key], _a));
        }
        return (0, merge_1.default)(cum, (0, exports.flattenErrors)(next, __spreadArray(__spreadArray([], path, true), [key], false)));
    }, {});
};
