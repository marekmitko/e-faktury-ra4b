    ...
    var result = (0, react_1.useMemo)(function () {
        ...
        if (options.choices || !context) {
            return {
                ...
                error: (_d = options.error) !== null && _d !== void 0 ? _d : list.displayedFilters,
                filter: (_e = options.filter) !== null && _e !== void 0 ? _e : list.filter,
                filterValues: (_f = options.filterValues) !== null && _f !== void 0 ? _f : list.filterValues,
                hasNextPage: (_g = options.hasNextPage) !== null && _g !== void 0 ? _g : list.hasNextPage,
                hasPreviousPage: (_h = options.hasPreviousPage) !== null && _h !== void 0 ? _h : list.hasPreviousPage,
                hideFilter: (_j = options.hideFilter) !== null && _j !== void 0 ? _j : list.hideFilter,
                isFetching: (_k = options.isFetching) !== null && _k !== void 0 ? _k : list.isFetching,
                isLoading: (_l = options.isLoading) !== null && _l !== void 0 ? _l : list.isLoading,
