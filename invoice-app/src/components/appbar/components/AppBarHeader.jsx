...
import { TitlePortal, RefreshIconButton, useSidebarState, useLocale } from 'react-admin';
import MenuIcon from '@mui/icons-material/Menu';
import EfaClientCreate from '../../clients/CLIENT-e-faktury/EfaClientCreate';
...
export default function AppBarHeader(props) {
  ...
  return (
    ...
    >
     ...
     <Toolbar sx={{ pl: 0, display: 'flex', justifyContent: 'space-between',    }}>
      <IconButton
