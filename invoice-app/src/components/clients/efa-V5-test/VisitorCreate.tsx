...
import NewMobiSelectInput from '../../invoices/new-invoice/invoice-create/components/efaV5/sales-form-iterator/sales-item/mobile-view/components/sales-item-row/mobi-item-content/NewMobiSelectInput';
        ...
        >
            ...
            <Box display={{ xs: 'block', sm: 'flex', width: '100%' }}>
                <Box flex={1} mr={{ xs: 0, sm: '0.5em' }}>
                    <TextInput source="first_name" isRequired fullWidth size="small" />
                </Box>
            ...
            <Box display={{ xs: 'block', sm: 'flex' }}>
                <Box flex={2} mr={{ xs: 0, sm: '0.5em' }}>
                    <NewMobiSelectInput  source="segmentsTest" />
