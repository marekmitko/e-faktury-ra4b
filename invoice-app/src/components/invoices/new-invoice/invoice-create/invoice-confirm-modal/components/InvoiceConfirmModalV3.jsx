...
import { useCreate, useNotify, useNotifyIsFormInvalid, useRedirect } from 'react-admin';
...
export default function InvoiceConfirmModalV3(props) {
    const { children, open, setOpen, methods, // create, navigate,
