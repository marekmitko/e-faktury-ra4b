    ...
    let myList = useGetList(
        ...
        useEffect(async () => {
            try {
                ...
                let resp = await myDataProvider.getList("userProfile",{ pagination: {  },
                sort: { },
                filter: {  },}) 
                let { data } = resp
                setResult( data )
        ...
        //  console.log("!myList➿", myList.data.map((item) => console.log("item", item) ) );
        
        return (
            <>
            {/* <p>{myList?.data?['0']? "dsa " : "" }</p> */}
                    <List   {  ...props}>
                        <Datagrid>
                            <TextField source="id" sortable={false} />
                            <TextField source="user_address" />
                            <TextField source="myPhone" />
                    ...
                    <List>
                        <Datagrid field={null}  data={myList.data} >
                            <TextField source="id" sortable={false} />
                            <TextField source="user_address" />
                            <TextField source="myPhone" />
    ...
    component="div"  {...props} > */}
        <RecordContextProvider value={record}>
            <FormProvider {...methods}>
                ...
                <form   id="new-invoice-form" onSubmit={form.handleSubmit(onSubmit2)} >
