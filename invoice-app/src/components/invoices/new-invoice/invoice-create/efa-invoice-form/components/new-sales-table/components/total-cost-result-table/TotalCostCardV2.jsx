...
export default function TotalCostCardV2(props) {
    ...
    return (
        <Card variant="plain" size="sm" sx={sxCSS}>
            <CardContent
                sx={{
                    p: 0,
                    m: 0,
                ...
                >
                    <tbody>
                        <tr>
                            <CellLabel>
                                {translate(
                                    "myroot.form.label.header_totalResultTable.totalNetCost"
                                )}
                            </CellLabel>
                            <CostCell>
                        ...
                        <tr>
                            <CellLabel>
                                {translate(
                                    "myroot.form.label.header_totalResultTable.totalTaxCost"
                                )}
                            </CellLabel>
                            <CostCell>
            ...
            >
                <Typography
                    ...
                    sx={{
                        m: 0.5,
                        typography: { sm: "h6", xs: "body1", md: "h5" },
                        width: "100%",
                        wordBreak: "break-all",
                    }}
                >
                    ...
                    >
                        {translate(
                            "myroot.form.label.header_totalResultTable.totalCost"
                        )}
                        {": "}
                    </TotalLabel>
                    <b>
