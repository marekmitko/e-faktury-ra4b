import { useState, useContext, useCallback, useRef, Children, isValidElement } from 'react';
import { useArrayInput, Confirm, useRecordContext, SimpleFormIteratorContext, useTranslate, FormDataConsumer} from 'react-admin';
...
export default function useProductFormIterator(props) {
    ...
    return { record, records, fields, translate, removeField, addField, move, replace };
  }
