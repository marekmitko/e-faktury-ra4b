...
export const SellerCompanyCardHeader = (props) => { 
                ...
                avatar={ 
                    <Box display="flex" sx={{ ml: -2, mr: 0,  mb: -2 }} >
                            <Avatar
                                ...
                                sx={{ bgcolor: 'neutral.100', p: 3.2 ,  opacity: .9,
                    ...
                    title={
                        <Typography variant="h6" color="text.secondary" component="div" sx={{ ml: -1, color: 'neutral.700' }} >
