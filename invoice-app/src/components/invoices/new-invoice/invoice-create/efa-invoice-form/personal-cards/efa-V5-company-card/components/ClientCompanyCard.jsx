...
const mySx = {
    minHeight: { xs: "72px", sm: "72px", md: "80px" },
    border: "1px solid #e9e9e9",
    borderRadius: 2,
    boxShadow: 0,
};

export default function ClientCompanyCard({
    icon = <BuyerIcon />,
    cardTitle,
    resourcePath,
    sx,
                    ...
                    <CompanyCardHeader
                        ...
                        suptitle={`${
                            buyerId
                                ? false
                                : translate(
                                      "myroot.form.label.header.buyerCardHeader_supporting_text"
                                  )
                        }`}
                    />
                    <CardContent
                        className="company-card-content-name"
                        sx={{ py: 0, ml: "75px", mb: -7 }}
                    >
                        <Box
                            sx={{
                                marginRight: -4.5,
