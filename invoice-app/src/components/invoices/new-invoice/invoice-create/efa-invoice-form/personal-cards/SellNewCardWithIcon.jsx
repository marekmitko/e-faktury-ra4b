...
import BuyerReferenceInput from '../../components/personal-cards/components/BuyerReferenceInput';
...
export default function SellNewCardWithIcon({icon, title, resourcePath }) {
        ...
        <Card sx={{ border: '1px solid #e9e9e9', borderRadius: 3 }} >
            <CardHeader sx={{ py:0, my: 0 }}
                ...
                <Box display="flex" sx={{ ml: -2, mr: 0,  mb: -2 }} >
                        <Avatar sx={{ bgcolor: 'primary.50', p: 3.5 ,  opacity: .9,
