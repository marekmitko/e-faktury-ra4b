import { Box, Typography, Stack, Table, TableHead, TableRow, TableCell, TableFooter, TableBody, Switch } from "@mui/material"
...
export default function SalesTableToolbar({control, setValue, record}){
    return(
        <Table> 
            <TableRow>
