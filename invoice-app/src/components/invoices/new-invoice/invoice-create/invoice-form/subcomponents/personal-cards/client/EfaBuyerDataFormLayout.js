...
export const EfaBuyerDataFromLayout = (props) =>  { 
    const translate = useTranslate();
    // const record = useRecordContext();
    return (
    <>
        {props.children}
        <BooleanInput  source="buyer_is_company" sx={{ alignItems: 'flex-start', p: 0, mt: '-15px' }} />
        {/* <NullableBooleanInput source="is_company" sx={{ alignItems: 'flex-start', p: 0, mt: '-15px' }} /> */}
        <Stack direction="row" spacing={2} width="100%" alignItems="center">
            <TextInput  source="buyer_org_nr" fullWidth               variant="standard"   />
        ...
        <TextInput  source="buyer_address" fullWidth                   variant="standard"   />
        <Stack
            direction="row"
        ...
        >
            ...
            <TextInput    source="buyer_place"  fullWidth  variant="standard" />
        </Stack>
        <Stack direction="row" gap={1} width="100%">
            <MailIcon />  <strong>{translate('myroot.myBuyersEfaktury.header.contact_section')}</strong>
        </Stack>
        <Stack direction="row"  spacing={2} width="100%" >
            <TextInput  source="buyer_firstname"  fullWidth variant="standard" />
            <TextInput source="buyer_lastname"  fullWidth  variant="standard"/>
        </Stack>
        <Stack direction="row" spacing={2} alignItems="center" width="100%">
            <Stack direction="row"spacing={2} alignItems="center" width="100%" >
                <MailOutlineSharpIcon sx={{ transform: 'scale(1.2)',  mb: 2 }}  />
                <TextInput  source="buyer_email" fullWidth variant="standard" />
            </Stack>
            <Stack direction="row"spacing={2} alignItems="center" width="100%" >
                <LocalPhoneIcon sx={{ transform: 'scale(1.2)',  mb: 2 }}  />
                <TextInput source="buyer_phone" fullWidth variant="standard" />
