    ...
    import { ResponsiveTableColumn, ResponsiveTableDesignOptions } from "../table-form-iterator/types";
    import { getDesignOptionsClasses } from "../table-form-iterator/utilis";
