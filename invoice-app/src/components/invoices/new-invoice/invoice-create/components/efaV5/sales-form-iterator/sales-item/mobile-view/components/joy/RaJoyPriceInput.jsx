...
export const JoySelectinputPriceFormat = React.forwardRef(
    function PriceNumberInput(props, ref) {
        // const {
        //     label,
        //     placeholder,
        //     helperText,
        ...
        let labelName = translate(
            "myroot.form.label.input.datePickerSelectinput.optionLabelName"
        );
        ...
        {({ filled, focused } ) => ( */}
                <Box
                    sx={{
                        display: "flex",
                        margin: "auto", // '& .datePickerSelectinput-input--main-root': { width: 'auto', pr: 0, }
                    }}
                >
                    <JoyInputField
                        hiddenLabel
                        ...
                        sx={{
                            ...
                            "& input": {
                                fontSize: "var(--mui-fontSize-md)",
                                color: "inherit",
                                textAlign: textAlignInput,
                            },
                            "& input:focus-visible ": { outline: "none" },
                            "& input::placeholder": {
                                color: props?.error ? "danger.500" : "",
                            },
    ...
    return (
        <Box sx={{ "& div": { width: "100%", margin: 0 } }}>
            ...
            <JoySelectinputPriceFormat
                ...
                slotProps={{
                    input: {
                        ...
                        placeholder:
                            isTouched || error
                                ? translate(
                                      "myroot.form.label.input.customText.errorPrice"
                                  )
                                : translate(
                                      "myroot.form.label.input.customText.enterPrice"
                                  ),
                    },
                }}
                {...field}
                ...
                // }}
                textAlignInput={
                    isTouched && isNaN(parseFloat(field.value))
                        ? "left"
                        : isTouched
                        ? "right"
                        : "left"
                ...
                error={
                    ...
                    (invalid || (isTouched && isNaN(parseFloat(field.value))))
                }
