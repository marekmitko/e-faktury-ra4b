...
export const SalesFormIteratorRowV5 = React.forwardRef((props, ref) => {
  const {
    // MobileFormIteratorItemProps
    children,
    disabled,
    disableReordering,
    disableRemove,
  ...
  return (
    <SimpleFormIteratorItemContext.Provider value={context}>
      <RootRowLine ref={ref} className={RowItemClassesPrefix}>
        ...
        {/* </Box> */}
        <InnerLinebox
          sxCSS={{ order: 1, m: 0, p: 0 }}
          className={RowItemClasses.inline}
        >
          <Card
            sx={{ p: 0, m: 0 }}
            component="section"
            className={RowItemClasses.rowSection}
          >
            {/* <Box sx={ wraperSectionItem }> */}
            <div style={{ gridArea: "rowInput" }}>
              <Card
                component="section"
                className="inputSection-itemRow"
                sx={{
              ...
              >
                ...
                <CardContent
                  component="tr"
                  sx={{ mx: 0.75, ...sxInputContent }}
                >
                  {" "}
                  {/*   GOTOWA KARTA WIERSZA  https://codesandbox.io/s/efa23-product-card-mobi-version-3-vphxjv */}
            ...
            {!isMedium && (
              ...
              >
                <Card
                  component="section"
                  className="outputSection-itemRow"
                  sx={{
                    p: 0,
                    ml: "auto",
                    mr: 0,
