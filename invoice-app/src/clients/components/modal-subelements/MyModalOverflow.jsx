...
import CloseModalContext from "./subcomponents/CloseModalContext";
import modalDialogClasses from "./modalOverflowClasses";
...
export const ModalOverflowRoot =
    // styled("div", {
 ...
 */
const MyModalOverflow = React.forwardRef(function ModalOverflow(inProps, ref) {
    const props =
        // (useThemeProps < typeof inProps) &
        // ModalOverflowProps >
        {
            props: inProps,
            name: "JoyModalOverflow",
...
export default MyModalOverflow;
